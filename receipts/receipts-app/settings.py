...
DATABASES = {
    'default': {
        ...
        'NAME': 'receipt.db',                      # Or path to database file if using sqlite3.
...
PICKLE_ROOT = 'D:\\AI\\receipt_budget\\receipts\\receipts\\ml_models'
# Absolute filesystem path to the directory that will hold user-uploaded files.
# Example: "/var/www/example.com/media/"
MEDIA_ROOT = 'D:/AI/receipt_budget/receipts/receipts/receipt_images'
...
SECRET_KEY = 'b4klxejpzvwivuq3(ywiz42h)0irjearwz4#zy+8d_4d6m+-&c'
